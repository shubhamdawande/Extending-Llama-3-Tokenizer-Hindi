...
def print_tokenizer_output(tokenizer):
    ...
    print('No. of tokens:', len(ids))
    print(tokens)

# llama 2
print('\n\n------------ LLAMA 2 ----------- ')
llama2_model_id = "meta-llama/Llama-2-7b-chat"
tokenizer = get_tokenizer('./llama2_tokenizer/tokenizer.model', llama2_model_id)
print_tokenizer_output(tokenizer)

# llama 3
print('\n\n------------ LLAMA 3 ----------- ')
llama3_model_id = "meta-llama/Meta-Llama-3-8B-Instruct"
tokenizer = get_tokenizer('./llama3_tokenizer/tokenizer.model', llama3_model_id)
print_tokenizer_output(tokenizer)
